...
const ERROR_MESSAGES: Record<string, string> = {
  not_registered: 'このGoogleアカウントはシステムに登録されていません。管理者に連絡してください。',
};
    ...
    <div className="flex items-center justify-center h-screen bg-[#080c14]">
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-[0.3em] text-white">AUTO OFFICE</h1>
          <p className="text-gray-500 text-sm mt-2">社内バーチャルオフィス</p>
        </div>

        {/* Card */}
        <div className="bg-gray-900 border border-gray-800 rounded-2xl px-10 py-8 flex flex-col items-center gap-6 w-80">
